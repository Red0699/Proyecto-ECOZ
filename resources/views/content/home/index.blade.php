          ...
          <div class="d-flex align-items-center justify-content-center">
            ...
            <div class="ms-2">
              <div class="fs-5 fw-semibold text-body">
                {{ number_format($kpis['inv_ult_gl'] ?? 0, 0) }} <span class="text-muted">gl</span>
              </div>
            ...
            <div class="col-12 col-md-4">
              <div class="h-100 p-2 ps-3 bg-light rounded border border-0 border-start border-4 border-danger-subtle">
                ...
                <div class="h5 mb-0 fw-bold text-danger">
                  {{ number_format($kpis['last_day_cov_kg'] ?? 0, 2) }}
            ...
            <div class="col-12 col-md-4">
              <div class="h-100 p-2 ps-3 bg-light rounded border border-0 border-start border-4 border-primary-subtle">
                ...
                <div class="h5 mb-0 fw-bold text-primary">
                  {{ number_format($kpis['last_day_co2_kg'] ?? 0, 2) }}
                  <span class="fs-6 fw-semibold text-body-secondary">kg</span>
                </div>
              </div>
            </div>

            {{-- NUEVO: Trabajo en el tanque COV --}}
            <div class="col-12 col-md-4">
              <div class="h-100 p-2 ps-3 bg-light rounded border border-0 border-start border-4 border-warning-subtle">
                <small class="text-body-secondary d-block">Emisión de Vapor</small>
                <div class="h5 mb-0 fw-bold text-warning">
                  {{ number_format($kpis['last_day_operacion_cov_kg'] ?? 0, 2) }}
                  <span class="fs-6 fw-semibold text-body-secondary">kg</span>
                </div>
              </div>
            </div>
